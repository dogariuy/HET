...
setwd("Output")
dir.create("20250701", showWarnings = FALSE)  # date of starting new analysis
setwd("20250701")
...
dir.create("Output 1 - Counts (BG subtr)", showWarnings = FALSE)
setwd("Output 1 - Counts (BG subtr)")
